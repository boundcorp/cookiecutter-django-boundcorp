...
DATABASE_NAME = os.environ.get("DATABASE_NAME", "{{cookiecutter.ci_project_title}}")
DATABASE_USER = os.environ.get("DATABASE_USER", "{{cookiecutter.ci_project_title}}")
DATABASE_PORT = os.environ.get("DATABASE_PORT", "5432")
DATABASE_PASSWORD = os.environ.get("DATABASE_PASSWORD", "{{cookiecutter.ci_project_title}}")
...
STATICFILES_DIRS: List[Tuple[str, str]] = [("frontend", root("frontend", "build"))]
...
if os.path.exists(credentials_file):
    ...
    MINIO_STORAGE_MEDIA_BUCKET_NAME = os.environ.get("MINIO_STORAGE_MEDIA_BUCKET_NAME", "{{cookiecutter.ci_project_title}}-assets")
...
GRAPHQL_AUTH = {
    "EMAIL_TEMPLATE_VARIABLES": {
        "site_name": "{{cookiecutter.ci_project_title}}}}",
        "protocol": PROTOCOL,
...
Q_CLUSTER = {
    "name": "{{cookiecutter.ci_project_title}} Queue",
    "workers": 4,
    "timeout": 90,
    "retry": 120,
    "queue_limit": 50,
